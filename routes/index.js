...
router.get('/mongodb', function (request, response) {
    ...
    mongodb.MongoClient.connect('mongodb://heroku_kx9zmnld:pmn23m892ji0hm0m5tcil7edql@ds019882.mlab.com:19882/heroku_kx9zmnld', function(err, client) {
        // mongodb.MongoClient.connect(process.env.MONGODB_URI, function(err, db) {  // works with mongodb v2 but not v3
        if(err) throw err;
        //get collection of routes
        var db = client.db('heroku_kx9zmnld');  // in v3 we need to get the db from the client
